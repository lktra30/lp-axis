            ...
            <div className="container mx-auto px-4 md:px-6 flex flex-col lg:flex-row items-center gap-12">
                ...
                >
                    ...
                    <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl">
                        A Axis substitui freelancers não confiáveis e agências caras por uma 
                        taxa mensal fixa, com soluções em IA e automações.
                    </p>
                    ...
                    <div className="mt-6 hidden sm:flex items-center">
                        <span className="text-sm text-gray-500 dark:text-gray-400">
                            Pause ou cancele a qualquer momento.
                        </span>
                    </div>
                </motion.div>
