      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-3">
              <li>
                <a href="https://wa.me/5500000000000" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#b668e9] transition-colors flex items-center">
              ...
              <li>
                <a href="mailto:suporte@axis.tech" className="text-gray-400 hover:text-[#b668e9] transition-colors flex items-center">
