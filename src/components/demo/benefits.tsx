...
const benefits = [
  ...
  },
  {
    ...
    description: "Sem freelancers complexos e agências caras. Na palma da sua mão sempre que precisar.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section className="py-24 bg-neutral-50 dark:bg-[#0c0812] overflow-hidden">
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center mb-16 relative z-10">
          ...
          >
            A Axis substitui freelancers complexos e agências caras por uma taxa mensal fixa, 
